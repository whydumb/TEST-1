...
// import com.kAIS.KAIMyEntity.vseeFace.VSeeFaceManager; // 임시 주석 처리
...
public class KAIMyEntityClient {
    ...
    public static void initClient() {
        ...
        // VSeeFace 매니저 초기화 (임시 주석 처리)
        // VSeeFaceManager.getInstance();
        logger.info("KAIMyEntityClient initialized");
    }

    // shutdown 메서드 추가 (게임 종료 시 호출)
    public static void shutdown() {
        // VSeeFaceManager.getInstance().shutdown(); // 임시 주석 처리
