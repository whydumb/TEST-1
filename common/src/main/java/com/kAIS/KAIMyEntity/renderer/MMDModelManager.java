...
public class MMDModelManager {
    ...
    public static class EntityData {
        public static HashMap<EntityState, String> stateProperty = new HashMap<>() {{
            ...
            // VR 상태 추가
            put(EntityState.VR_HandLeft, "vrHandLeft");
            put(EntityState.VR_HandRight, "vrHandRight");
            put(EntityState.VR_Seated, "vrSeated");
            put(EntityState.VR_Standing, "vrStanding");
        }};
        ...
        // VR 상태 필드 추가
        public VRPlayerRenderer.VRState vrState = VRPlayerRenderer.VRState.NONE;

        public enum EntityState {Idle, Walk, Sprint, Air, OnClimbable, OnClimbableUp, OnClimbableDown, Swim, Ride, Ridden, Driven, Sleep, ElytraFly, Die, SwingRight, SwingLeft, ItemRight, ItemLeft, Sneak, OnHorse, Crawl, LieDown, VR_HandLeft, VR_HandRight, VR_Seated, VR_Standing}
    }
}