    ...
    */
    ...
    public void startReceiving() {
        ...
        */
        ...
        // 임시 구현
        isRunning = true;
        logger.info("VSeeFace receiver started (OSC functionality disabled temporarily)");
    }
    ...
    public void stopReceiving() {
        if (isRunning) {
            ...
            */
            isRunning = false;
            logger.info("VSeeFace receiver stopped");
        }
    }

    // 쿼터니언을 오일러각으로 변환 (주석 처리)
    /*
